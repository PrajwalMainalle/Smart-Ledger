...
function GstSales() {
  ...
  const handleExportCSV = () => {
    ...
    rows.push("NON-GST SALES REPORT");
    rows.push("GST Slab,Taxable Value,CGST Amount,SGST Amount,IGST Amount,Total Tax Value,Total Gross Value");
    ...
    <div className="w-full bg-slate-950 text-slate-100 min-h-screen p-4 md:p-8 rounded-2xl border border-slate-900 print:bg-white print:text-black print:border-none print:p-0 print:m-0">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 print:hidden">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Audit outward tax collections and taxable value groupings.</p>
        </div>
      ...
      <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-5 shadow-xl">
        <h3 className="text-sm font-bold uppercase tracking-wider text-slate-400 mb-4">GST Sales Outward Tally (With GST Number)</h3>
      ...
      <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-5 shadow-xl mt-6">
        <h3 className="text-sm font-bold uppercase tracking-wider text-slate-400 mb-4">Non-GST Sales Outward Tally (Without GST Number)</h3>
