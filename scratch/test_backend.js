...
const purchaseController = require("../backend/controllers/purchaseController");
...
async function runTest() {
  ...
  const createPurchaseBillModule = require("../backend/controllers/purchaseController").createPurchaseBill;
